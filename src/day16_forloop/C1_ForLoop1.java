...
public class C1_ForLoop1 {
    ...
    public static void rakamlarToplamiYazdir(int sayi) {
        ...
        String sayi2=sayi+""; // sayi1 i String e cevirdik cunku forloop icin uzunluk gerekiyor
        // length() methodu Stringde kullanilir

        for (int i = 1; i <= sayi2.length(); i++) {

            rakamlarToplami+=sayi%10; // rakamlarToplami= rakamlarToplami + sayi%10;
            sayi/=10;				  // sayi= sayi/10;
        }
        System.out.println("rakamlar toplami : "+ rakamlarToplami); // disina yazdik cunku for body icine yazarsak
        // hersefer toplami yazar
