package day08_javaPractiseElifHoca;
...
public class Q05_EscapeSequences {
    ...
    Örneğin; sekme, satır başı ve geri alma gibi karakterleri
             bir çıkış akışına koymak için kaçış dizilerini kullanabilirsiniz.
    ...
    public static void main(String[] args) {
        ...
        // sonraki "TechProEd ile java cok kolay ..." ifadesi  3 satir sonra ve satir basindan
        // 1 tab ileride yazilsin, hepsini tek kod satırı ile yazdiriniz.
