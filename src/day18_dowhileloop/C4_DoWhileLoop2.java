...
public class C4_DoWhileLoop2 {
    public static void main(String[] args) {
        ...
        */
        ...
        int countNeg=0;
        int toplamPoz=0;
        int sayi=1; // sifir demedik cunku oyun bitmesin diye,
        // aslinda bitmez ama ne olur ne olmaz :)
        // aslinda ne yazdigininda bir önemi yok cunku 33 satirda assing yaptik
        ...
        do {
            ...
            if (sayi>0) {
                ...
                countPoz++;
                toplamPoz += sayi; // toplamPoz = toplamPoz + sayi;
        ...
        } while(sayi != 0); // kullanici 0 a basmadigi surece sayi != 0 ==> 0!=0 ==> false
